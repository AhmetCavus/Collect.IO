...
class SocketService {
    ...
    [onConnection](channel, socket) {
		...
		socket.on(SOCKET.COMMAND_SEND_BROADCAST, (data) => { channelRepo.broadcast(data, channel, socket); });
        socket.on(SOCKET.COMMAND_REQUEST_AI_DATA, (data) => { channelRepo.requestAiData(data, socket); });
        socket.on(SOCKET.COMMAND_REQUEST_COLLECTION, (data) => { channelRepo.requestCollection(data, socket); });
        socket.on(SOCKET.COMMAND_SEND_PRIVATE_MESSAGE, (data) => { channelRepo.sendPrivateMessage(data, channel, socket); });
        socket.on(SOCKET.COMMAND_COLLECTION_ADD_ITEM, (data) => { channelRepo.addItem(data, channel, socket); });
        socket.on(SOCKET.COMMAND_COLLECTION_REMOVE_ITEM, (data) => { this._listener.removeItem(data, channel, socket); });
        socket.on(SOCKET.COMMAND_COLLECTION_UPDATE_ITEM, (data) => { this._listener.update(data, channel, socket); });
        socket.on(SOCKET.COMMAND_UPDATE, (data) => { this.channelRepo.update(data, channel, socket); });
        socket.on(SOCKET.COMMAND_USE_API, (data) => { this[onUseApi](data, channel, socket); });
        socket.on(SOCKET.COMMAND_DISCONNECT, (data) => { this[onDisconnect](data, channel, socket); });
